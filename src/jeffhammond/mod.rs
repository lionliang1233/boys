...
#[bench]
fn bench_boys1_jeffhammond_2(b: &mut Bencher) {
    b.iter(|| {
        boys1(2, 2.0);
    });
}
#[bench]
fn bench_boys2_jeffhammond_2(b: &mut Bencher) {
    b.iter(|| {
        boys2(2, 2.0);
    });
}
...
#[bench]
fn bench_boys3_jeffhammond_2(b: &mut Bencher) {
    b.iter(|| {
        boys3(2, 2.0);
    });
}
...
#[bench]
fn bench_boys1_jeffhammond_14(b: &mut Bencher) {
    b.iter(|| {
        boys1(14, 42.67768466983068);
    });
}
#[bench]
fn bench_boys2_jeffhammond_14(b: &mut Bencher) {
    b.iter(|| {
        boys2(14, 42.67768466983068);
    });
}

#[bench]
fn bench_boys3_jeffhammond_14(b: &mut Bencher) {
    b.iter(|| {
        boys3(14, 42.67768466983068);
    });
}
